/* /////////////////////////////////////////////////////////////////////////
 * File:    test.unit.winstl.time.comparison_operators/entry.cpp
 *
 * Purpose: Unit-tests for `time/comparison_operators`.
 *
...
int main(int argc, char* argv[])
{
    ...
    if (XTESTS_START_RUNNER("test.unit.winstl.time.comparison_operators", verbosity))
    {
