/* /////////////////////////////////////////////////////////////////////////
 * File:    test.unit.winstl.time.localisation_functions/entry.cpp
 *
 * Purpose: Unit-tests for `time/localisation_functions`.
 *
...
int main(int argc, char* argv[])
{
    ...
    if (XTESTS_START_RUNNER("test.unit.winstl.time.localisation_functions", verbosity))
    {
