/* /////////////////////////////////////////////////////////////////////////
 * File:    test.unit.winstl.time.creation_functions/entry.cpp
 *
 * Purpose: Unit-tests for `time/creation_functions`.
 *
...
int main(int argc, char* argv[])
{
    ...
    if (XTESTS_START_RUNNER("test.unit.winstl.time.creation_functions", verbosity))
    {
