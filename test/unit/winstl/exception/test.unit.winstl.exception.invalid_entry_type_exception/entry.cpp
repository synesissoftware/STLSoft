/* /////////////////////////////////////////////////////////////////////////
 * File:    test.unit.winstl.exception.invalid_entry_type_exception/entry.cpp
 *
 * Purpose: Unit-tests for `exception/invalid_entry_type_exception`.
 *
...
int main(int argc, char* argv[])
{
    ...
    if (XTESTS_START_RUNNER("test.unit.winstl.exception.invalid_entry_type_exception", verbosity))
    {
