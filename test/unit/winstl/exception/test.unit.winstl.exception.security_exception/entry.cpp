/* /////////////////////////////////////////////////////////////////////////
 * File:    test.unit.winstl.exception.security_exception/entry.cpp
 *
 * Purpose: Unit-tests for `exception/security_exception`.
 *
...
int main(int argc, char* argv[])
{
    ...
    if (XTESTS_START_RUNNER("test.unit.winstl.exception.security_exception", verbosity))
    {
