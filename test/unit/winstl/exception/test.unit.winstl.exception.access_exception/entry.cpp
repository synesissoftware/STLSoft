/* /////////////////////////////////////////////////////////////////////////
 * File:    test.unit.winstl.exception.access_exception/entry.cpp
 *
 * Purpose: Unit-tests for `exception/access_exception`.
 *
...
int main(int argc, char* argv[])
{
    ...
    if (XTESTS_START_RUNNER("test.unit.winstl.exception.access_exception", verbosity))
    {
