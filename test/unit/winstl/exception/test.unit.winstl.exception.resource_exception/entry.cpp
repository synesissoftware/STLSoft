/* /////////////////////////////////////////////////////////////////////////
 * File:    test.unit.winstl.exception.resource_exception/entry.cpp
 *
 * Purpose: Unit-tests for `exception/resource_exception`.
 *
...
int main(int argc, char* argv[])
{
    ...
    if (XTESTS_START_RUNNER("test.unit.winstl.exception.resource_exception", verbosity))
    {
