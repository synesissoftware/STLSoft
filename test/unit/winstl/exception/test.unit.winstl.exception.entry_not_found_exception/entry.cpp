/* /////////////////////////////////////////////////////////////////////////
 * File:    test.unit.winstl.exception.entry_not_found_exception/entry.cpp
 *
 * Purpose: Unit-tests for `exception/entry_not_found_exception`.
 *
...
int main(int argc, char* argv[])
{
    ...
    if (XTESTS_START_RUNNER("test.unit.winstl.exception.entry_not_found_exception", verbosity))
    {
