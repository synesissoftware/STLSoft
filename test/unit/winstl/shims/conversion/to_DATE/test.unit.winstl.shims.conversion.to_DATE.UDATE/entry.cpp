/* /////////////////////////////////////////////////////////////////////////
 * File:    test.unit.winstl.shims.conversion.to_DATE.UDATE/entry.cpp
 *
 * Purpose: Unit-tests for `shims/conversion/to_DATE/UDATE`.
 *
...
int main(int argc, char* argv[])
{
    ...
    if (XTESTS_START_RUNNER("test.unit.winstl.shims.conversion.to_DATE.UDATE", verbosity))
    {
