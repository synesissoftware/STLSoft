/* /////////////////////////////////////////////////////////////////////////
 * File:    test.unit.winstl.shims.conversion.to_FILETIME.DATE/entry.cpp
 *
 * Purpose: Unit-tests for `shims/conversion/to_FILETIME/DATE`.
 *
...
int main(int argc, char* argv[])
{
    ...
    if (XTESTS_START_RUNNER("test.unit.winstl.shims.conversion.to_FILETIME.DATE", verbosity))
    {
