/* Purpose: unit-tests for stlsoft/exception/library_identifier_provider */
...
int main(int argc, char* argv[]) {
    ...
    if (XTESTS_START_RUNNER("test.unit.stlsoft.exception.library_identifier_provider", verbosity)) {
