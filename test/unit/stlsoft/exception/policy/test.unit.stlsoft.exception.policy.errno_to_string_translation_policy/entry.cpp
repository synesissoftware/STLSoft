/* Purpose: unit-tests for stlsoft/exception/policy/errno_to_string_translation_policy */
...
int main(int argc, char* argv[]) {
    ...
    if (XTESTS_START_RUNNER("test.unit.stlsoft.exception.policy.errno_to_string_translation_policy", verbosity)) {
