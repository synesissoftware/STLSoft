/* Purpose: unit-tests for stlsoft/exception/util/status_code_translating_exception_base */
...
int main(int argc, char* argv[]) {
    ...
    if (XTESTS_START_RUNNER("test.unit.stlsoft.exception.util.status_code_translating_exception_base", verbosity)) {
