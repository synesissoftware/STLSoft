/* Purpose: unit-tests for stlsoft/exceptions/external_iterator_invalidation */
...
int main(int argc, char* argv[]) {
    ...
    if (XTESTS_START_RUNNER("test.unit.stlsoft.exceptions.external_iterator_invalidation", verbosity)) {
