/* /////////////////////////////////////////////////////////////////////////
 * File:    test.unit.stlsoft.shims.attribute.get_ptr.std.fundamental/entry.cpp
 *
...
int main(int argc, char* argv[])
{
    ...
    if (XTESTS_START_RUNNER("test.unit.stlsoft.shims.attribute.get_ptr.std.fundamental", verbosity))
    {
