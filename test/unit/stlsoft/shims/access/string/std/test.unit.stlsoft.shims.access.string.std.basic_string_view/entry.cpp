/* /////////////////////////////////////////////////////////////////////////
 * File:    test.unit.stlsoft.shims.access.string.std.basic_string_view/entry.cpp
 *
...
int main(int argc, char* argv[])
{
    ...
    if (XTESTS_START_RUNNER("test.unit.stlsoft.shims.access.string.std.basic_string_view", verbosity))
    {
