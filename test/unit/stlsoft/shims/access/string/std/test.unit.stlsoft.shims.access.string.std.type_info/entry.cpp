/* /////////////////////////////////////////////////////////////////////////
 * File:    test.unit.stlsoft.shims.access.string.std.type_info/entry.cpp
 *
...
int main(int argc, char* argv[])
{
    ...
    if (XTESTS_START_RUNNER("test.unit.stlsoft.shims.access.string.std.type_info", verbosity))
    {
