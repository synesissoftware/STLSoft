/* /////////////////////////////////////////////////////////////////////////
 * File:    test.unit.stlsoft.conversion.m2w/entry.cpp
 *
 * Purpose: Unit-tests for `stlsoft/conversion/m2w`.
 *
...
int main(int argc, char* argv[])
{
    ...
    if (XTESTS_START_RUNNER("test.unit.stlsoft.conversion.m2w", verbosity))
    {
