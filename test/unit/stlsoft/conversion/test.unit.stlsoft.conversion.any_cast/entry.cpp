/* /////////////////////////////////////////////////////////////////////////
 * File:    test.unit.stlsoft.conversion.any_cast/entry.cpp
 *
 * Purpose: Unit-tests for `stlsoft/conversion/any_cast`.
 *
...
int main(int argc, char* argv[])
{
    ...
    if (XTESTS_START_RUNNER("test.unit.stlsoft.conversion.any_cast", verbosity))
    {
