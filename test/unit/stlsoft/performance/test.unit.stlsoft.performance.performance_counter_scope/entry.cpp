/* /////////////////////////////////////////////////////////////////////////
 * File:    test.unit.stlsoft.performance.performance_counter_scope/entry.cpp
 *
...
int main(int argc, char* argv[])
{
    ...
    if (XTESTS_START_RUNNER("test.unit.stlsoft.performance.performance_counter_scope", verbosity))
    {
