/* Purpose: unit-tests for stlsoft/error/active_end_iterator_exhaustion */
...
int main(int argc, char* argv[]) {
    ...
    if (XTESTS_START_RUNNER("test.unit.stlsoft.error.active_end_iterator_exhaustion", verbosity)) {
