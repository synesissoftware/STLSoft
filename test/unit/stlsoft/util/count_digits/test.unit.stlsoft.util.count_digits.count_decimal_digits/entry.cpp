/* /////////////////////////////////////////////////////////////////////////
 * File:    test.unit.stlsoft.util.count_digits.count_decimal_digits/entry.cpp
 *
...
int main(int argc, char* argv[])
{
    ...
    if (XTESTS_START_RUNNER("test.unit.stlsoft.util.count_digits.count_decimal_digits", verbosity))
    {
