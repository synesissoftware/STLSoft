/* /////////////////////////////////////////////////////////////////////////
 * File:    test.component.winstl.filesystem.memory_mapped_file/entry.cpp
 *
...
int main(int argc, char* argv[])
{
    ...
    if (XTESTS_START_RUNNER("test.component.winstl.filesystem.memory_mapped_file", verbosity))
    {
