/* /////////////////////////////////////////////////////////////////////////
 * File:    test.component.winstl.filesystem.handles.os_file_handle/entry.cpp
 *
...
int main(int argc, char* argv[])
{
    ...
    if (XTESTS_START_RUNNER("test.component.winstl.filesystem.handles.os_file_handle", verbosity))
    {
