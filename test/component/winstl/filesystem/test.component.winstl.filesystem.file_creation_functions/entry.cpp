/* /////////////////////////////////////////////////////////////////////////
 * File:    test.component.winstl.filesystem.file_creation_functions/entry.cpp
 *
...
int main(int argc, char* argv[])
{
    ...
    if (XTESTS_START_RUNNER("test.component.winstl.filesystem.file_creation_functions", verbosity))
    {
