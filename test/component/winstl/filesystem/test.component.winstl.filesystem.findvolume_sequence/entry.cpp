/* /////////////////////////////////////////////////////////////////////////
 * File:    test.component.winstl.filesystem.findvolume_sequence/entry.cpp
 *
...
int main(int argc, char* argv[])
{
    ...
    if (XTESTS_START_RUNNER("test.component.winstl.filesystem.findvolume_sequence", verbosity))
    {
