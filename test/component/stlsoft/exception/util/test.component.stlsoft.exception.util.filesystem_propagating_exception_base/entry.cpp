/* Purpose: component-tests for stlsoft/exception/util/filesystem_propagating_exception_base */
...
int main(int argc, char* argv[]) {
    ...
    if (XTESTS_START_RUNNER("test.component.stlsoft.exception.util.filesystem_propagating_exception_base", verbosity)) {
